...
/**
 * EXCERCISE IS TO MAKE GORAUD LIGHTING IN VIEW SPACE
 * which is similar to Phong, but in the vertex shader...
 * 
 * TO COMPILE:
 *      g++ GoraudShading.cpp ./../../include/glad/include/glad.c ./../../include/src/window.cpp ./../../include/src/Shader.cpp ./../../include/src/Texture.cpp ./../../include/src/Mesh.cpp ./../../include/src/element_buffer.cpp ./../../include/src/vertex_buffer.cpp ./../../include/src/camera.cpp ./../../include/src/input.cpp -Wall -Wextra -lglfw3 -ldl -lX11 -pthread -I./../../include/ -o GoraudShading
 *
 * WITHOUT EXTRA WARNINGS:
 *      g++ GoraudShading.cpp ./../../include/glad/include/glad.c ./../../include/src/window.cpp ./../../include/src/Shader.cpp ./../../include/src/Texture.cpp ./../../include/src/Mesh.cpp ./../../include/src/element_buffer.cpp ./../../include/src/vertex_buffer.cpp ./../../include/src/camera.cpp ./../../include/src/input.cpp -Wall -lglfw3 -ldl -lX11 -pthread -I./../../include/ -o GoraudShading
*/
...
const std::string SRC_VERTEX =
    ...
    "   vec3 lightDir = normalize(lightPosition - vPos.xyz);\n"
    "   vec3 normal = (view * model * vec4(aNormal, 0.0)).xyz;\n"
    "   float intensity = clamp(dot(lightDir, normal), 0.0, 1.0);\n"
    // specular (view space)
    "   vec3 viewDir = normalize(vec3(0) - vPos.xyz);\n"
    "   vec3 reflection = reflect(-lightDir, normal);\n"
    "   float specular = pow( clamp( dot(reflection, viewDir), 0.0, 1.0), 8);\n"
    // send output to fragment shader
    "   lighting = intensity + specular;"
    "   texCoord = aTexCoord;\n"
...
const std::string SRC_FRAGMENT =
    ...
    "void main() {\n"
    // color
    "   vec3 color = lightColor * objectColor * (ambientFactor + lighting);\n"
    ...
    public:
        ...
        */
        ...
        void OnRenderLight(const glm::mat4& view, const glm::mat4& proj) {
            ...
            cubes.at(0)->GetShader().SetVec3("lightPosition", lightPos);
